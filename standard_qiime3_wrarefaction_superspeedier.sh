...
#  standard_qiime3_wrarefaction_superspeedier.sh
#  
#
#  Created by John Chaston on 7/29/26.
#  
...
qiime diversity alpha --i-table table_$name"".qza --p-metric observed_features --o-alpha-diversity core-metrics-results-$name""-$i/observed_features_vector.qza

qiime diversity alpha --i-table table_$name"".qza --p-metric shannon --o-alpha-diversity core-metrics-results-$name""-$i/shannon_vector.qza

qiime diversity alpha --i-table table_$name"".qza --p-metric pielou_e --o-alpha-diversity core-metrics-results-$name""-$i/evenness_vector.qza
